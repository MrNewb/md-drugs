...
function MethCooking()
	...
	local thermite = CreatePropModel('hei_prop_heist_thermite', vector3(1005.76, -3201.3, -39.25), 0.0, true)
	FreezeEntityPosition(thermite, true)
	SetEntityRotation(thermite, 190.0, 90.0, 140.0, 3, true)
	Wait(1000)
	local therm = StartParticleFxLoopedOnEntity('scr_heist_ornate_thermal_burn', thermite, 0.0, 1.4, 0.0, 0.0, 0.0, 0.0,
...
function Tray()
	...
	AttachEntityToEntity(trays, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 28422), 0.01, -0.2, -0.2, 20.0, 0.0, 0.0,
...
function SpawnCarPedChase()
	...
	if started then
		...
		started = true
		RegisterModelRequest("cargobob3")
		local leancar = CreateVehicle("pounder", vector3(start.x + 3, start.y - 2, start.z - 1), 52.0, true)
		local driver = CreatePedModel("ig_priest", vector3(start.x, start.y, start.z), 268.9422, false, false)
		local pilot2 = CreatePedModel("ig_priest", vector3(stoploc.x - 3, stoploc.y - 3, stoploc.z - 1), 268.9422, false,
			false)
		FreezeEntityPosition(pilot2, true)
		SetEntityInvincible(pilot2, true)
		SetEntityAsMissionEntity(leancar, true, true)
...
function SpawnMethCarPedChase()
	...
	if startedmeth then
		...
		startedmeth = true
		RegisterModelRequest("journey")
		RegisterModelRequest("a_m_m_hillbilly_02")
		RegisterModelRequest("cargobob3")
		...
		local methpilot = CreatePed(26, "a_m_m_hillbilly_02", stoploc.x - 3, stoploc.y - 3, stoploc.z - 1, 268.9422,
			false, false)
		FreezeEntityPosition(methpilot, true)
		SetEntityInvincible(methpilot, true)
		SetEntityAsMissionEntity(methcar, true, true)
